defmodule Mix.Tasks.BuildDictionary do
  ...
  @function_words %{
    ...
    "aren't" => [%{"pos" => "contraction", "def" => "are not"}],
    "can't" => [%{"pos" => "contraction", "def" => "cannot"}],
    "couldn't" => [%{"pos" => "contraction", "def" => "could not"}],
    "didn't" => [%{"pos" => "contraction", "def" => "did not"}],
    "doesn't" => [%{"pos" => "contraction", "def" => "does not"}],
    "don't" => [%{"pos" => "contraction", "def" => "do not"}],
    "hadn't" => [%{"pos" => "contraction", "def" => "had not"}],
    "hasn't" => [%{"pos" => "contraction", "def" => "has not"}],
    "haven't" => [%{"pos" => "contraction", "def" => "have not"}],
    "he'd" => [%{"pos" => "contraction", "def" => "he had; he would"}],
    "he'll" => [%{"pos" => "contraction", "def" => "he will; he shall"}],
    "he's" => [%{"pos" => "contraction", "def" => "he is; he has"}],
    "here's" => [%{"pos" => "contraction", "def" => "here is"}],
    "i'd" => [%{"pos" => "contraction", "def" => "I had; I would"}],
    "i'll" => [%{"pos" => "contraction", "def" => "I will; I shall"}],
    "i'm" => [%{"pos" => "contraction", "def" => "I am"}],
    "i've" => [%{"pos" => "contraction", "def" => "I have"}],
    "isn't" => [%{"pos" => "contraction", "def" => "is not"}],
    "it'd" => [%{"pos" => "contraction", "def" => "it had; it would"}],
    "it'll" => [%{"pos" => "contraction", "def" => "it will; it shall"}],
    "it's" => [%{"pos" => "contraction", "def" => "it is; it has"}],
    "let's" => [%{"pos" => "contraction", "def" => "let us"}],
    "mightn't" => [%{"pos" => "contraction", "def" => "might not"}],
    "mustn't" => [%{"pos" => "contraction", "def" => "must not"}],
    "needn't" => [%{"pos" => "contraction", "def" => "need not"}],
    "shan't" => [%{"pos" => "contraction", "def" => "shall not"}],
    "she'd" => [%{"pos" => "contraction", "def" => "she had; she would"}],
    "she'll" => [%{"pos" => "contraction", "def" => "she will; she shall"}],
    "she's" => [%{"pos" => "contraction", "def" => "she is; she has"}],
    "shouldn't" => [%{"pos" => "contraction", "def" => "should not"}],
    "that'd" => [%{"pos" => "contraction", "def" => "that had; that would"}],
    "that'll" => [%{"pos" => "contraction", "def" => "that will; that shall"}],
    "that's" => [%{"pos" => "contraction", "def" => "that is; that has"}],
    "there'd" => [%{"pos" => "contraction", "def" => "there had; there would"}],
    "there'll" => [%{"pos" => "contraction", "def" => "there will; there shall"}],
    "there's" => [%{"pos" => "contraction", "def" => "there is; there has"}],
    "they'd" => [%{"pos" => "contraction", "def" => "they had; they would"}],
    "they'll" => [%{"pos" => "contraction", "def" => "they will; they shall"}],
    "they're" => [%{"pos" => "contraction", "def" => "they are"}],
    "they've" => [%{"pos" => "contraction", "def" => "they have"}],
    "wasn't" => [%{"pos" => "contraction", "def" => "was not"}],
    "we'd" => [%{"pos" => "contraction", "def" => "we had; we would"}],
    "we'll" => [%{"pos" => "contraction", "def" => "we will; we shall"}],
    "we're" => [%{"pos" => "contraction", "def" => "we are"}],
    "we've" => [%{"pos" => "contraction", "def" => "we have"}],
    "weren't" => [%{"pos" => "contraction", "def" => "were not"}],
    "what'd" => [%{"pos" => "contraction", "def" => "what did; what had; what would"}],
    "what'll" => [%{"pos" => "contraction", "def" => "what will; what shall"}],
    "what're" => [%{"pos" => "contraction", "def" => "what are"}],
    "what's" => [%{"pos" => "contraction", "def" => "what is; what has; what does"}],
    "what've" => [%{"pos" => "contraction", "def" => "what have"}],
    "when's" => [%{"pos" => "contraction", "def" => "when is; when has"}],
    "where'd" => [%{"pos" => "contraction", "def" => "where did"}],
    "where's" => [%{"pos" => "contraction", "def" => "where is; where has"}],
    "where've" => [%{"pos" => "contraction", "def" => "where have"}],
    "who'd" => [%{"pos" => "contraction", "def" => "who had; who would"}],
    "who'll" => [%{"pos" => "contraction", "def" => "who will; who shall"}],
    "who're" => [%{"pos" => "contraction", "def" => "who are"}],
    "who's" => [%{"pos" => "contraction", "def" => "who is; who has"}],
    "who've" => [%{"pos" => "contraction", "def" => "who have"}],
    "why'd" => [%{"pos" => "contraction", "def" => "why did"}],
    "why'll" => [%{"pos" => "contraction", "def" => "why will"}],
    "why's" => [%{"pos" => "contraction", "def" => "why is; why has"}],
    "won't" => [%{"pos" => "contraction", "def" => "will not"}],
    "wouldn't" => [%{"pos" => "contraction", "def" => "would not"}],
    "y'all" => [%{"pos" => "contraction", "def" => "you all (plural you)"}],
    "you'd" => [%{"pos" => "contraction", "def" => "you had; you would"}],
    "you'll" => [%{"pos" => "contraction", "def" => "you will; you shall"}],
    "you're" => [%{"pos" => "contraction", "def" => "you are"}],
    "you've" => [%{"pos" => "contraction", "def" => "you have"}],
    "ain't" => [
      %{"pos" => "contraction", "def" => "am not; is not; are not; has not; have not (informal)"}
    ],
    "could've" => [%{"pos" => "contraction", "def" => "could have"}],
    "would've" => [%{"pos" => "contraction", "def" => "would have"}],
    "should've" => [%{"pos" => "contraction", "def" => "should have"}],
    "might've" => [%{"pos" => "contraction", "def" => "might have"}],
    "must've" => [%{"pos" => "contraction", "def" => "must have"}],
    "how'd" => [%{"pos" => "contraction", "def" => "how did; how would"}],
    "how'll" => [%{"pos" => "contraction", "def" => "how will"}],
    "how's" => [%{"pos" => "contraction", "def" => "how is; how has; how does"}],
    "ma'am" => [%{"pos" => "noun", "def" => "a polite form of address for a woman"}],
    "o'clock" => [%{"pos" => "adverb", "def" => "used to specify the hour when telling time"}],
    "ne'er" => [%{"pos" => "adverb", "def" => "never (poetic/archaic)"}],
    "e'er" => [%{"pos" => "adverb", "def" => "ever (poetic/archaic)"}],
    "o'er" => [%{"pos" => "preposition", "def" => "over (poetic/archaic)"}],
    "'twas" => [%{"pos" => "contraction", "def" => "it was (archaic/literary)"}],
    "'tis" => [%{"pos" => "contraction", "def" => "it is (archaic/literary)"}],
    "y'know" => [%{"pos" => "interjection", "def" => "you know (informal filler)"}],
    "c'mon" => [%{"pos" => "interjection", "def" => "come on (informal)"}],
    "gonna" => [%{"pos" => "contraction", "def" => "going to (informal)"}],
    "gotta" => [%{"pos" => "contraction", "def" => "got to; have got to (informal)"}],
    "wanna" => [%{"pos" => "contraction", "def" => "want to (informal)"}],
    "kinda" => [%{"pos" => "adverb", "def" => "kind of; somewhat (informal)"}],
    "sorta" => [%{"pos" => "adverb", "def" => "sort of; somewhat (informal)"}],
    "dunno" => [%{"pos" => "contraction", "def" => "don't know (informal)"}],
    "gimme" => [%{"pos" => "contraction", "def" => "give me (informal)"}],
    "lemme" => [%{"pos" => "contraction", "def" => "let me (informal)"}]
  }
