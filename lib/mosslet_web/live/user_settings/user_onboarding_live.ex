        ...
        <div class="w-full max-w-4xl mx-auto">
          <div class="flex flex-col lg:flex-row lg:gap-8">
                    ...
                    <label class="flex items-start gap-3 p-3.5 rounded-xl cursor-pointer transition-all duration-200 hover:bg-slate-50 dark:hover:bg-slate-700/30 group">
                      ...
                      <div class="flex-1 min-w-0">
                        ...
                        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                          {gettext(
                            "Gentle badges only while you're active—we respect your offline time"
                          )}
                        </p>
                      </div>
                    </label>
            ...
            <div class="mt-8 lg:mt-0 lg:w-80 lg:flex-shrink-0">
              <.liquid_card padding="md" class="overflow-hidden sticky top-8">
                ...
                <div class="space-y-2">
                  ...
                  <div class={[
                    ...
                    <div class="px-3 pb-4 pt-2 space-y-4 text-sm text-slate-600 dark:text-slate-400">
                      ...
                      <div class="grid grid-cols-2 gap-2">
                        <div class="text-center p-2.5 rounded-lg bg-gradient-to-br from-rose-50 to-red-50 dark:from-rose-900/20 dark:to-red-900/20 border border-rose-200/50 dark:border-rose-800/30">
                  ...
                  <div class={[
                    ...
                    <div class="px-3 pb-4 pt-2 space-y-3 text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                      <p>
                        {gettext(
                          "When a service is \"free,\" you become the product. Your data is harvested, packaged, and sold to the highest bidder."
                        )}
                      </p>
                      ...
                      <ul class="space-y-1.5">
                        <li class="flex items-start gap-2">
                          ...
                          />
                          <span>{gettext("Keep your data private")}</span>
                        </li>
                        <li class="flex items-start gap-2">
                          <.phx_icon
                            name="hero-check-circle"
                            class="w-4 h-4 text-emerald-500 mt-0.5 flex-shrink-0"
                          />
                          <span>{gettext("Build features for you")}</span>
                        </li>
                        <li class="flex items-start gap-2">
                          <.phx_icon
                            name="hero-check-circle"
                            class="w-4 h-4 text-emerald-500 mt-0.5 flex-shrink-0"
                          />
                          <span>{gettext("Stay independent")}</span>
                        </li>
                      </ul>
                      <div class="p-3 rounded-xl bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 border border-emerald-200/50 dark:border-emerald-700/30">
                        <div class="flex items-center gap-2">
                          <.phx_icon
                            name="hero-sparkles"
                          ...
                          <div class="text-xs text-emerald-700 dark:text-emerald-300">
                            {gettext("Monthly, yearly, or lifetime access")}
                          </div>
                        </div>
                      </div>
                    </div>
