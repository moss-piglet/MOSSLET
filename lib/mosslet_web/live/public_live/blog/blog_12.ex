      ...
      >
        ...
        <ul>
          <li>
            ...
            Create entries with optional titles, track your mood from 120+ different options (joyful, anxious, nostalgic, creative — whatever fits), and watch your word count grow as you reflect.
          </li>
          <li>
