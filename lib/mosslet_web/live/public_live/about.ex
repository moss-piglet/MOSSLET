        ...
        <div class="isolate">
          ...
          <div id="blog" class="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
            ...
            <div class="mx-auto mt-16 grid max-w-2xl auto-rows-fr grid-cols-1 gap-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
              <.article_preview
                id="blogPostZKPQ"
                img_source={~p"/images/blog/may_25_2026_zkpq.jpg"}
                date="May 25, 2026"
              ...
              <.article_preview
                id="blogPostTFIC"
                img_source={~p"/images/blog/apr_27_2026_tfic.jpg"}
                date="April 27, 2026"
              ...
              <.article_preview
                id="blogPostHWBPFAI"
                img_source={~p"/images/blog/jan_15_2026_hwbpfai.jpg"}
              ...
              <.article_preview
                id="blogPostPBLOP"
                img_source={~p"/images/blog/jan_07_2026_ijpsr.jpg"}
                date="January 07, 2026"
