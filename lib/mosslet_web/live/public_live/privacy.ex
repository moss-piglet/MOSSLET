                ...
                >
                  ...
                  >
                    ...
                    <p>
                      ...
                      (like when your account was confirmed) is symmetrically encrypted at rest by our servers and stored with your non-object data. It is not zero-knowledge encrypted because it doesn't reveal anything about you — just operational flags like whether your account was confirmed, which are needed for the service to function.
                    </p>
                    <p>
                    ...
                    <div class="p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border-l-4 border-yellow-500">
                      ...
                      <ul class="space-y-1 text-sm">
                        ...
                        <li>
                          ...
                          Processed and stored by Stripe, not by us (we store only Stripe-generated IDs for synchronization — these are opaque identifiers, not your personal content)
                        </li>
                        <li>
                  ...
                  >
                    <div class="pt-4">
                      ...
                      <p>
                        ...
                        to synchronize with Stripe (<span class="px-2 py-1 bg-rose-200 dark:bg-rose-300 text-rose-900 rounded text-sm">encrypted at rest with AES-256-GCM</span>
                        and deterministically hashed for lookups on our end), and subscription information (like dates and status). These Stripe IDs are opaque identifiers generated by Stripe — they don't contain your personal information, and our server needs to read them to process payments on your behalf.
                      </p>
                        ...
                        <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                          ...
                          <p class="text-sm mb-3">
                            ...
                            <span class="px-2 py-1 bg-rose-200 dark:bg-rose-300 text-rose-900 rounded text-xs">
                              Stripe IDs in our database are encrypted at rest, but our server can read them because it needs to call Stripe APIs on your behalf. However, these are opaque Stripe-generated identifiers (like "cus_abc123") — they don't contain your name, email, or any personal content.
                            </span>
                          </p>
