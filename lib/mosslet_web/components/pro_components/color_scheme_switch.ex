defmodule MossletWeb.ColorSchemeSwitch do
  @moduledoc false
  ...
  def color_scheme_switch(assigns) do
    ...
    <button
      ...
      class={"color-scheme cursor-pointer text-background-500 dark:text-gray-400 hover:bg-background-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-background-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 #{@class}"}
    >
      <svg
        class="hidden w-5 h-5 color-scheme-dark-icon text-gray-400"
        fill="currentColor"
        viewBox="0 0 20 20"
      ...
      <svg
        class="hidden w-5 h-5 color-scheme-light-icon text-background-400"
        fill="currentColor"
        viewBox="0 0 20 20"
        xmlns="http://www.w3.org/2000/svg"
      >
