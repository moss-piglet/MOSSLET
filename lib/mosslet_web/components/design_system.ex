defmodule MossletWeb.DesignSystem do
  ...
  def liquid_card(assigns) do
    ...
    <div class={[
      ...
      <div :if={render_slot(@title)} class="mb-4 pb-3 border-b border-slate-200/60 dark:border-slate-700/60">
  ...
  def liquid_nav_item(assigns) do
    ...
    >
      ...
      <div :if={!@mobile_full_width} class={[
  ...
  defp button_variant_classes("secondary") do
    [
      ...
      "hover:from-emerald-100 hover:to-cyan-100 hover:text-emerald-700",
      "dark:hover:from-emerald-900/30 dark:hover:to-cyan-900/30 dark:hover:text-emerald-300",
      "hover:border-emerald-300 dark:hover:border-emerald-600",
      "focus-visible:outline-slate-600"
    ]
  end

  defp button_variant_classes("ghost") do
    [
      "text-slate-600 dark:text-slate-300",
      "hover:bg-gradient-to-r hover:from-emerald-50 hover:to-cyan-50",
      "dark:hover:from-emerald-900/20 dark:hover:to-cyan-900/20",
