defmodule Mosslet.Timeline.BookmarkCategory do
  ...
  schema "bookmark_categories" do
    ...
    field :name, Mosslet.Encrypted.Binary       # Category name (Cloak encrypted)
    field :name_hash, Mosslet.Encrypted.HMAC    # For searching categories by name
    field :description, Mosslet.Encrypted.Binary # Category description
    
    # PLAINTEXT FIELDS (system data, not sensitive)
    field :color, Ecto.Enum, 
      values: [:emerald, :blue, :purple, :amber, :rose, :cyan], 
      default: :emerald
    field :icon, :string, default: "hero-bookmark"  # Hero icon name
