defmodule Mosslet.Timeline.Adapter do
  ...
  @callback list_connection_posts_query(
              current_user :: User.t(),
              connection_user_ids :: [String.t()],
              options :: map()
            ) :: [Post.t()]
  @callback list_group_posts_query(current_user :: User.t(), options :: map()) :: [Post.t()]
  @callback list_discover_posts_query(current_user :: User.t() | nil, options :: map()) :: [
              Post.t()
            ]
  ...
  @callback fetch_timeline_posts_from_db_query(current_user :: User.t(), options :: map()) :: [
              Post.t()
            ]
  @callback get_recently_active_users(time_window_minutes :: integer(), max_users :: integer()) ::
              [User.t()]
  ...
  @callback public_post_count_with_options(user :: User.t() | nil, options :: map()) ::
              non_neg_integer()
  ...
  @callback count_user_connection_posts(
              current_user :: User.t(),
              connection_user_ids :: [String.t()],
              options :: map()
            ) :: non_neg_integer()
  ...
  @callback count_unread_connection_posts(
              current_user :: User.t(),
              connection_user_ids :: [String.t()],
              options :: map()
            ) :: non_neg_integer()
  @callback count_group_posts(current_user :: User.t(), options :: map()) :: non_neg_integer()
  @callback count_unread_group_posts(current_user :: User.t(), options :: map()) ::
              non_neg_integer()
  @callback count_discover_posts(current_user :: User.t() | nil, options :: map()) ::
              non_neg_integer()
  @callback count_unread_discover_posts(current_user :: User.t(), options :: map()) ::
              non_neg_integer()
  ...
  @callback create_post_transaction(multi :: Ecto.Multi.t()) ::
              {:ok, map()} | {:error, atom(), any(), map()}
  @callback create_public_post_transaction(multi :: Ecto.Multi.t()) ::
              {:ok, map()} | {:error, atom(), any(), map()}
  @callback create_repost_transaction(multi :: Ecto.Multi.t()) ::
              {:ok, map()} | {:error, atom(), any(), map()}
  @callback create_targeted_share_transaction(multi :: Ecto.Multi.t()) ::
              {:ok, map()} | {:error, atom(), any(), map()}
  @callback update_post(changeset :: Ecto.Changeset.t()) ::
              {:ok, Post.t()} | {:error, Ecto.Changeset.t()}
  @callback update_public_post(changeset :: Ecto.Changeset.t()) ::
              {:ok, Post.t()} | {:error, Ecto.Changeset.t()}
  @callback delete_post(post :: Post.t()) :: {:ok, Post.t()} | {:error, Ecto.Changeset.t()}
  @callback delete_group_post_transaction(multi :: Ecto.Multi.t()) ::
              {:ok, map()} | {:error, atom(), any(), map()}
  ...
  @callback update_post_fav(changeset :: Ecto.Changeset.t()) ::
              {:ok, Post.t()} | {:error, Ecto.Changeset.t()}
  @callback update_post_repost(changeset :: Ecto.Changeset.t()) ::
              {:ok, Post.t()} | {:error, Ecto.Changeset.t()}
  @callback update_post_shared_users(changeset :: Ecto.Changeset.t()) ::
              {:ok, Post.t()} | {:error, Ecto.Changeset.t()}
  @callback update_post_shared_users_without_validation(changeset :: Ecto.Changeset.t()) ::
              {:ok, Post.t()} | {:error, Ecto.Changeset.t()}
  @callback remove_post_shared_user_transaction(multi :: Ecto.Multi.t()) ::
              {:ok, map()} | {:error, atom(), any(), map()}
  @callback share_post_with_user_transaction(multi :: Ecto.Multi.t()) ::
              {:ok, map()} | {:error, atom(), any(), map()}
  @callback remove_content_warning_from_post(changeset :: Ecto.Changeset.t()) ::
              {:ok, Post.t()} | {:error, Ecto.Changeset.t()}
  ...
  @callback get_or_create_user_post_for_public_transaction(multi :: Ecto.Multi.t()) ::
              {:ok, map()} | {:error, atom(), any(), map()}
  @callback delete_user_post(user_post :: UserPost.t()) ::
              {:ok, UserPost.t()} | {:error, Ecto.Changeset.t()}
  @callback remove_self_from_shared_post_transaction(multi :: Ecto.Multi.t()) ::
              {:ok, map()} | {:error, atom(), any(), map()}
  ...
  @callback get_user_post_receipt(current_user :: User.t(), post :: Post.t()) ::
              UserPostReceipt.t() | nil
  @callback get_unread_post_for_user_and_post(post :: Post.t(), current_user :: User.t()) ::
              UserPostReceipt.t() | nil
  ...
  @callback update_user_post_receipt_read(id :: String.t()) ::
              {:ok, UserPostReceipt.t()} | {:error, :not_found | Ecto.Changeset.t()}
  @callback update_user_post_receipt_unread(id :: String.t()) ::
              {:ok, UserPostReceipt.t()} | {:error, :not_found | Ecto.Changeset.t()}
  ...
  @callback create_reply(changeset :: Ecto.Changeset.t()) ::
              {:ok, Reply.t()} | {:error, Ecto.Changeset.t()}
  @callback update_reply(changeset :: Ecto.Changeset.t()) ::
              {:ok, Reply.t()} | {:error, Ecto.Changeset.t()}
  ...
  @callback update_reply_fav(changeset :: Ecto.Changeset.t()) ::
              {:ok, Reply.t()} | {:error, Ecto.Changeset.t()}
  ...
  @callback mark_replies_read_for_post(post_id :: String.t(), user_id :: String.t()) ::
              non_neg_integer()
  @callback mark_direct_replies_read_for_post(
              post_id :: String.t(),
              user_id :: String.t(),
              now :: DateTime.t()
            ) :: non_neg_integer()
  @callback mark_nested_replies_read_for_post(
              post_id :: String.t(),
              user_id :: String.t(),
              now :: DateTime.t()
            ) :: non_neg_integer()
  ...
  @callback mark_all_direct_replies_read_for_user(user_id :: String.t(), now :: DateTime.t()) ::
              non_neg_integer()
  @callback mark_all_nested_replies_read_for_user(user_id :: String.t(), now :: DateTime.t()) ::
              non_neg_integer()
  ...
  @callback create_bookmark(changeset :: Ecto.Changeset.t()) ::
              {:ok, Bookmark.t()} | {:error, Ecto.Changeset.t()}
  @callback update_bookmark(changeset :: Ecto.Changeset.t()) ::
              {:ok, Bookmark.t()} | {:error, Ecto.Changeset.t()}
  ...
  @callback create_bookmark_category(changeset :: Ecto.Changeset.t()) ::
              {:ok, BookmarkCategory.t()} | {:error, Ecto.Changeset.t()}
  @callback update_bookmark_category(changeset :: Ecto.Changeset.t()) ::
              {:ok, BookmarkCategory.t()} | {:error, Ecto.Changeset.t()}
  ...
  @callback report_post_transaction(multi :: Ecto.Multi.t()) ::
              {:ok, map()} | {:error, atom(), any(), map()}
  @callback update_post_report(changeset :: Ecto.Changeset.t()) ::
              {:ok, PostReport.t()} | {:error, Ecto.Changeset.t()}
  ...
  @callback hide_post(changeset :: Ecto.Changeset.t()) ::
              {:ok, PostHide.t()} | {:error, Ecto.Changeset.t()}
  @callback unhide_post(user :: User.t(), post :: Post.t()) ::
              {:ok, PostHide.t()} | {:error, :not_found}
  ...
  @callback create_system_content_warning_category(changeset :: Ecto.Changeset.t()) ::
              {:ok, ContentWarningCategory.t()} | {:error, Ecto.Changeset.t()}
  @callback create_user_content_warning_category(changeset :: Ecto.Changeset.t()) ::
              {:ok, ContentWarningCategory.t()} | {:error, Ecto.Changeset.t()}
  ...
  @callback upsert_user_timeline_preference(changeset :: Ecto.Changeset.t()) ::
              {:ok, UserTimelinePreference.t()} | {:error, Ecto.Changeset.t()}
