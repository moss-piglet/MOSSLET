defmodule Mosslet.Workers.DeleteObjectStoragePostWorker do
  @moduledoc """
  Oban job for deleting Post files from object storage.
  ...
  @doc """
  This handles deleting all Post images from the cloud.
  """
  def perform(%Oban.Job{
    ...
    case make_async_aws_requests(urls) do
      result ->
        Logger.info("DeleteObjectStoragePostWorker make_async_aws_resquests")
