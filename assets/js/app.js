...
window.moodPickerGetButtonClasses = function (moodId, currentValue) {
  const baseClasses =
    "group flex items-center gap-2 px-2.5 py-2 sm:px-3 sm:py-2.5 rounded-lg text-left min-w-0 transition-colors duration-150 ease-out focus:outline-none focus:ring-2 focus:ring-teal-500/50";
