!(function (e) {
  function a(e, a) {
      ...
      _ = a.ready.then(function () {
        function t() {
          ...
          for (
            ...
            "function" == typeof r["_" + a[_]] && (e[a[_]] = t[_]);
          var n = [
          ...
          for (_ = 0; _ < n.length; _++)
            "function" == typeof (c = r["_" + n[_].toLowerCase()]) &&
              (e[n[_]] = c());
          var s = [
            "SODIUM_VERSION_STRING",
          ...
          for (_ = 0; _ < s.length; _++) {
            var c;
            "function" == typeof (c = r["_" + s[_].toLowerCase()]) &&
              (e[s[_]] = r.UTF8ToString(c()));
          }
        }
        r = a;
        try {
    ...
    function n(e) {
      ...
      for (var a = new Uint8Array(e.length), r = 0, t = e.length; r < t; r++)
        a[r] = e.charCodeAt(r);
      return a;
    }
    function s(e) {
    ...
    function c(e) {
      e = E(null, e, "input");
      for (var a, r, t, _ = "", n = 0; n < e.length; n++)
        (t =
          ((87 + (r = 15 & e[n]) + (((r - 10) >> 8) & -39)) << 8) |
          (87 + (a = e[n] >>> 4) + (((a - 10) >> 8) & -39))),
          (_ += String.fromCharCode(255 & t) + String.fromCharCode(t >>> 8));
      return _;
    }
    var o = {
      ORIGINAL: 1,
    ...
    function p(e, a) {
      ...
      var t,
        ...
        c = e.length - 3 * n,
        o = 4 * n + (0 !== c ? (2 & a ? 2 + (c >>> 1) : 4) : 0),
        p = new u(o + 1),
        y = d(e);
      return (
        _.push(y),
        _.push(p.address),
        0 === r._sodium_bin2base64(p.address, p.length, y, e.length, a) &&
    ...
    function i(e) {
      for (
        var a = ["uint8array", "text", "hex", "base64"], r = 0;
        r < a.length;
        r++
      )
        if (a[r] === e) return !0;
    ...
    function v(e) {
      var a = r._malloc(e);
      if (0 === a) throw { message: "_malloc() failed", length: e };
      return a;
    }
    function g(e) {
    ...
    function E(e, a, r) {
      return (
        ...
        a instanceof Uint8Array
          ...
          : "string" == typeof a
          ? n(a)
          : void f(e, "unsupported input type for " + r)
      );
    }
    function x(e, a, t, _, n, s) {
      ...
      null != e &&
        ...
        (a = E(c, a, "ciphertext"));
      var h,
        p = r._crypto_aead_aegis128l_abytes(),
        i = a.length;
      i < p && f(c, "ciphertext is too short"), (h = d(a)), c.push(h);
      var v = null,
        m = 0;
      null != t &&
        ((v = d((t = E(c, t, "additional_data")))), (m = t.length), c.push(v)),
        (_ = E(c, _, "public_nonce"));
      var x,
        k = 0 | r._crypto_aead_aegis128l_npubbytes();
      _.length !== k && f(c, "invalid public_nonce length"),
        (x = d(_)),
        c.push(x),
        (n = E(c, n, "key"));
      var S,
        T = 0 | r._crypto_aead_aegis128l_keybytes();
      n.length !== T && f(c, "invalid key length"), (S = d(n)), c.push(S);
      var w = new u((i - r._crypto_aead_aegis128l_abytes()) | 0),
        Y = w.address;
      if (
        (c.push(Y),
        0 ===
          r._crypto_aead_aegis128l_decrypt(Y, null, o, h, i, 0, v, m, 0, x, S))
      ) {
        var B = y(w, s);
        return g(c), B;
      }
    ...
    function k(e, a, t, _, n, s, c) {
      ...
      var x = null,
        k = 0;
      null != _ &&
        ((x = d((_ = E(o, _, "additional_data")))), (k = _.length), o.push(x)),
        (n = E(o, n, "public_nonce"));
      var S,
        T = 0 | r._crypto_aead_aegis128l_npubbytes();
      n.length !== T && f(o, "invalid public_nonce length"),
        (S = d(n)),
        o.push(S),
        (s = E(o, s, "key"));
      var w,
        Y = 0 | r._crypto_aead_aegis128l_keybytes();
      ...
      if (
        (o.push(A),
        0 ===
          r._crypto_aead_aegis128l_decrypt_detached(
            A,
            h,
            p,
            i,
    ...
    function S(e, a, t, _, n, s) {
      ...
      var p = null,
        i = 0;
      null != a &&
        ((p = d((a = E(c, a, "additional_data")))), (i = a.length), c.push(p));
      var v = null;
      null != t &&
        ((v = d((t = E(c, t, "secret_nonce")))), t.length, c.push(v)),
        (_ = E(c, _, "public_nonce"));
      var m,
        x = 0 | r._crypto_aead_aegis128l_npubbytes();
      _.length !== x && f(c, "invalid public_nonce length"),
        (m = d(_)),
        c.push(m),
        (n = E(c, n, "key"));
      var k,
        S = 0 | r._crypto_aead_aegis128l_keybytes();
      n.length !== S && f(c, "invalid key length"), (k = d(n)), c.push(k);
      var T = new u((h + r._crypto_aead_aegis128l_abytes()) | 0),
        w = T.address;
      if (
        (c.push(w),
        0 ===
          r._crypto_aead_aegis128l_encrypt(w, null, o, h, 0, p, i, 0, v, m, k))
      ) {
        var Y = y(T, s);
        return g(c), Y;
      }
    ...
    function T(e, a, t, _, n, s) {
      ...
      var T = new u(0 | h),
        w = T.address;
      c.push(w);
      var Y = new u(0 | r._crypto_aead_aegis128l_abytes()),
        B = Y.address;
      if (
        (c.push(B),
        0 ===
          r._crypto_aead_aegis128l_encrypt_detached(
            w,
            B,
            null,
            o,
    ...
    function w(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_aead_aegis128l_keybytes()),
        _ = t.address;
    ...
    function Y(e, a, t, _, n, s) {
      ...
      null != e &&
        ...
        (a = E(c, a, "ciphertext"));
      var h,
        p = r._crypto_aead_aegis256_abytes(),
        i = a.length;
      i < p && f(c, "ciphertext is too short"), (h = d(a)), c.push(h);
      var v = null,
        m = 0;
      null != t &&
        ...
        (_ = E(c, _, "public_nonce"));
      var x,
        k = 0 | r._crypto_aead_aegis256_npubbytes();
      _.length !== k && f(c, "invalid public_nonce length"),
        (x = d(_)),
        c.push(x),
        (n = E(c, n, "key"));
      var S,
        T = 0 | r._crypto_aead_aegis256_keybytes();
      n.length !== T && f(c, "invalid key length"), (S = d(n)), c.push(S);
      var w = new u((i - r._crypto_aead_aegis256_abytes()) | 0),
        Y = w.address;
      if (
        (c.push(Y),
        0 ===
          r._crypto_aead_aegis256_decrypt(Y, null, o, h, i, 0, v, m, 0, x, S))
      ) {
        var B = y(w, s);
        return g(c), B;
      }
    ...
    function B(e, a, t, _, n, s, c) {
      ...
      null != _ &&
        ...
        (n = E(o, n, "public_nonce"));
      var S,
        T = 0 | r._crypto_aead_aegis256_npubbytes();
      n.length !== T && f(o, "invalid public_nonce length"),
        (S = d(n)),
        o.push(S),
        (s = E(o, s, "key"));
      var w,
        Y = 0 | r._crypto_aead_aegis256_keybytes();
      s.length !== Y && f(o, "invalid key length"), (w = d(s)), o.push(w);
      var B = new u(0 | i),
        A = B.address;
      if (
        (o.push(A),
        0 ===
          r._crypto_aead_aegis256_decrypt_detached(
            A,
            h,
            p,
            i,
    ...
    function A(e, a, t, _, n, s) {
      ...
      null != t &&
        ...
        (_ = E(c, _, "public_nonce"));
      var m,
        x = 0 | r._crypto_aead_aegis256_npubbytes();
      _.length !== x && f(c, "invalid public_nonce length"),
        (m = d(_)),
        c.push(m),
        (n = E(c, n, "key"));
      var k,
        S = 0 | r._crypto_aead_aegis256_keybytes();
      n.length !== S && f(c, "invalid key length"), (k = d(n)), c.push(k);
      var T = new u((h + r._crypto_aead_aegis256_abytes()) | 0),
        w = T.address;
      if (
        (c.push(w),
        0 ===
          r._crypto_aead_aegis256_encrypt(w, null, o, h, 0, p, i, 0, v, m, k))
      ) {
        var Y = y(T, s);
        return g(c), Y;
      }
    ...
    function M(e, a, t, _, n, s) {
      ...
      var T = new u(0 | h),
        w = T.address;
      c.push(w);
      var Y = new u(0 | r._crypto_aead_aegis256_abytes()),
        B = Y.address;
      if (
        (c.push(B),
        0 ===
          r._crypto_aead_aegis256_encrypt_detached(
            w,
            B,
            null,
            o,
    ...
    function I(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_aead_aegis256_keybytes()),
        _ = t.address;
    ...
    function K(e, a, t, _, n, s) {
      ...
      null != e &&
        ...
        (a = E(c, a, "ciphertext"));
      var h,
        p = r._crypto_aead_chacha20poly1305_abytes(),
        i = a.length;
      i < p && f(c, "ciphertext is too short"), (h = d(a)), c.push(h);
      var v = null,
        m = 0;
      ...
      _.length !== k && f(c, "invalid public_nonce length"),
        ...
        (n = E(c, n, "key"));
      var S,
        T = 0 | r._crypto_aead_chacha20poly1305_keybytes();
      n.length !== T && f(c, "invalid key length"), (S = d(n)), c.push(S);
      var w = new u((i - r._crypto_aead_chacha20poly1305_abytes()) | 0),
        Y = w.address;
      if (
        (c.push(Y),
        0 ===
    ...
    function N(e, a, t, _, n, s, c) {
      ...
      null != _ &&
        ...
        (n = E(o, n, "public_nonce"));
      var S,
        T = 0 | r._crypto_aead_chacha20poly1305_npubbytes();
      n.length !== T && f(o, "invalid public_nonce length"),
        (S = d(n)),
        o.push(S),
        (s = E(o, s, "key"));
      var w,
        Y = 0 | r._crypto_aead_chacha20poly1305_keybytes();
      s.length !== Y && f(o, "invalid key length"), (w = d(s)), o.push(w);
      var B = new u(0 | i),
        A = B.address;
      if (
    ...
    function L(e, a, t, _, n, s) {
      ...
      n.length !== S && f(c, "invalid key length"), (k = d(n)), c.push(k);
      var T = new u((h + r._crypto_aead_chacha20poly1305_abytes()) | 0),
        w = T.address;
      if (
        (c.push(w),
        0 ===
    ...
    function O(e, a, t, _, n, s) {
      ...
      var T = new u(0 | h),
        w = T.address;
      c.push(w);
      var Y = new u(0 | r._crypto_aead_chacha20poly1305_abytes()),
        B = Y.address;
      if (
        (c.push(B),
        0 ===
    ...
    function U(e, a, t, _, n, s) {
      ...
      null != e &&
        ...
        (a = E(c, a, "ciphertext"));
      var h,
        p = r._crypto_aead_chacha20poly1305_ietf_abytes(),
        i = a.length;
      i < p && f(c, "ciphertext is too short"), (h = d(a)), c.push(h);
      var v = null,
        m = 0;
      ...
      _.length !== k && f(c, "invalid public_nonce length"),
        ...
        (n = E(c, n, "key"));
      var S,
        T = 0 | r._crypto_aead_chacha20poly1305_ietf_keybytes();
      n.length !== T && f(c, "invalid key length"), (S = d(n)), c.push(S);
      var w = new u((i - r._crypto_aead_chacha20poly1305_ietf_abytes()) | 0),
        Y = w.address;
      if (
        (c.push(Y),
        0 ===
    ...
    function C(e, a, t, _, n, s, c) {
      ...
      null != _ &&
        ...
        (n = E(o, n, "public_nonce"));
      var S,
        T = 0 | r._crypto_aead_chacha20poly1305_ietf_npubbytes();
      n.length !== T && f(o, "invalid public_nonce length"),
        (S = d(n)),
        o.push(S),
        (s = E(o, s, "key"));
      var w,
        Y = 0 | r._crypto_aead_chacha20poly1305_ietf_keybytes();
      s.length !== Y && f(o, "invalid key length"), (w = d(s)), o.push(w);
      var B = new u(0 | i),
        A = B.address;
      if (
    ...
    function P(e, a, t, _, n, s) {
      ...
      n.length !== S && f(c, "invalid key length"), (k = d(n)), c.push(k);
      var T = new u((h + r._crypto_aead_chacha20poly1305_ietf_abytes()) | 0),
        w = T.address;
      if (
        (c.push(w),
        0 ===
    ...
    function R(e, a, t, _, n, s) {
      ...
      var T = new u(0 | h),
        w = T.address;
      c.push(w);
      var Y = new u(0 | r._crypto_aead_chacha20poly1305_ietf_abytes()),
        B = Y.address;
      if (
        (c.push(B),
        0 ===
    ...
    function X(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_aead_chacha20poly1305_ietf_keybytes()),
        _ = t.address;
    ...
    function G(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_aead_chacha20poly1305_keybytes()),
        _ = t.address;
    ...
    function D(e, a, t, _, n, s) {
      ...
      null != e &&
        ...
        (a = E(c, a, "ciphertext"));
      var h,
        p = r._crypto_aead_xchacha20poly1305_ietf_abytes(),
        i = a.length;
      i < p && f(c, "ciphertext is too short"), (h = d(a)), c.push(h);
      var v = null,
        m = 0;
      ...
      _.length !== k && f(c, "invalid public_nonce length"),
        ...
        (n = E(c, n, "key"));
      var S,
        T = 0 | r._crypto_aead_xchacha20poly1305_ietf_keybytes();
      n.length !== T && f(c, "invalid key length"), (S = d(n)), c.push(S);
      var w = new u((i - r._crypto_aead_xchacha20poly1305_ietf_abytes()) | 0),
        Y = w.address;
      if (
        (c.push(Y),
        0 ===
    ...
    function F(e, a, t, _, n, s, c) {
      ...
      null != _ &&
        ...
        (n = E(o, n, "public_nonce"));
      var S,
        T = 0 | r._crypto_aead_xchacha20poly1305_ietf_npubbytes();
      n.length !== T && f(o, "invalid public_nonce length"),
        (S = d(n)),
        o.push(S),
        (s = E(o, s, "key"));
      var w,
        Y = 0 | r._crypto_aead_xchacha20poly1305_ietf_keybytes();
      s.length !== Y && f(o, "invalid key length"), (w = d(s)), o.push(w);
      var B = new u(0 | i),
        A = B.address;
      if (
    ...
    function V(e, a, t, _, n, s) {
      ...
      n.length !== S && f(c, "invalid key length"), (k = d(n)), c.push(k);
      var T = new u((h + r._crypto_aead_xchacha20poly1305_ietf_abytes()) | 0),
        w = T.address;
      if (
        (c.push(w),
        0 ===
    ...
    function H(e, a, t, _, n, s) {
      ...
      var T = new u(0 | h),
        w = T.address;
      c.push(w);
      var Y = new u(0 | r._crypto_aead_xchacha20poly1305_ietf_abytes()),
        B = Y.address;
      if (
        (c.push(B),
        0 ===
    ...
    function W(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_aead_xchacha20poly1305_ietf_keybytes()),
        _ = t.address;
    ...
    function q(e, a, t) {
      var _ = [];
      l(t);
      var n = d((e = E(_, e, "message"))),
        s = e.length;
      _.push(n), (a = E(_, a, "key"));
      var c,
        o = 0 | r._crypto_auth_keybytes();
      a.length !== o && f(_, "invalid key length"), (c = d(a)), _.push(c);
      var h = new u(0 | r._crypto_auth_bytes()),
        p = h.address;
    ...
    function j(e, a, t) {
      ...
      _.push(n), (a = E(_, a, "key"));
      var c,
        o = 0 | r._crypto_auth_hmacsha256_keybytes();
      a.length !== o && f(_, "invalid key length"), (c = d(a)), _.push(c);
      var h = new u(0 | r._crypto_auth_hmacsha256_bytes()),
        p = h.address;
    ...
    function Q(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_auth_hmacsha256_keybytes()),
        _ = t.address;
    ...
    function Z(e, a, t) {
      ...
      var n = d((a = E(_, a, "message_chunk"))),
        s = a.length;
      _.push(n),
        0 | r._crypto_auth_hmacsha256_update(e, n, s) && b(_, "invalid usage"),
        g(_);
    }
    function $(e, a, t) {
      var _ = [];
      e = E(_, e, "tag");
      var n,
        s = 0 | r._crypto_auth_hmacsha256_bytes();
      e.length !== s && f(_, "invalid tag length"), (n = d(e)), _.push(n);
      var c = d((a = E(_, a, "message"))),
        o = a.length;
      _.push(c), (t = E(_, t, "key"));
      var h,
        p = 0 | r._crypto_auth_hmacsha256_keybytes();
    ...
    function ee(e, a, t) {
      ...
      _.push(n), (a = E(_, a, "key"));
      var c,
        o = 0 | r._crypto_auth_hmacsha512_keybytes();
      a.length !== o && f(_, "invalid key length"), (c = d(a)), _.push(c);
      var h = new u(0 | r._crypto_auth_hmacsha512_bytes()),
        p = h.address;
    ...
    function ae(e, a, t) {
      ...
      _.push(n), (a = E(_, a, "key"));
      var c,
        o = 0 | r._crypto_auth_hmacsha512256_keybytes();
      a.length !== o && f(_, "invalid key length"), (c = d(a)), _.push(c);
      var h = new u(0 | r._crypto_auth_hmacsha512256_bytes()),
        p = h.address;
    ...
    function _e(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_auth_hmacsha512256_keybytes()),
        _ = t.address;
    ...
    function ne(e, a, t) {
      ...
      var n = d((a = E(_, a, "message_chunk"))),
        s = a.length;
      _.push(n),
        0 | r._crypto_auth_hmacsha512256_update(e, n, s) &&
          b(_, "invalid usage"),
        g(_);
    }
    function se(e, a, t) {
      ...
      e = E(_, e, "tag");
      var n,
        s = 0 | r._crypto_auth_hmacsha512256_bytes();
      e.length !== s && f(_, "invalid tag length"), (n = d(e)), _.push(n);
      var c = d((a = E(_, a, "message"))),
        o = a.length;
      _.push(c), (t = E(_, t, "key"));
      var h,
        p = 0 | r._crypto_auth_hmacsha512256_keybytes();
      t.length !== p && f(_, "invalid key length"), (h = d(t)), _.push(h);
    ...
    function ce(e, a) {
      var t = [];
      l(a), m(t, e, "state_address");
      var _ = new u(0 | r._crypto_auth_hmacsha512_bytes()),
        n = _.address;
    ...
    function he(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_auth_hmacsha512_keybytes()),
        _ = t.address;
    ...
    function pe(e, a, t) {
      ...
      var n = d((a = E(_, a, "message_chunk"))),
        s = a.length;
      _.push(n),
        0 | r._crypto_auth_hmacsha512_update(e, n, s) && b(_, "invalid usage"),
        g(_);
    }
    function ye(e, a, t) {
      var _ = [];
      e = E(_, e, "tag");
      var n,
        s = 0 | r._crypto_auth_hmacsha512_bytes();
      e.length !== s && f(_, "invalid tag length"), (n = d(e)), _.push(n);
      var c = d((a = E(_, a, "message"))),
        o = a.length;
      _.push(c), (t = E(_, t, "key"));
      var h,
        p = 0 | r._crypto_auth_hmacsha512_keybytes();
      t.length !== p && f(_, "invalid key length"), (h = d(t)), _.push(h);
    ...
    function ie(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_auth_keybytes()),
        _ = t.address;
    ...
    function le(e, a, t) {
      ...
      e = E(_, e, "tag");
      var n,
        s = 0 | r._crypto_auth_bytes();
      e.length !== s && f(_, "invalid tag length"), (n = d(e)), _.push(n);
      var c = d((a = E(_, a, "message"))),
        o = a.length;
      _.push(c), (t = E(_, t, "key"));
      var h,
        p = 0 | r._crypto_auth_keybytes();
      t.length !== p && f(_, "invalid key length"), (h = d(t)), _.push(h);
    ...
    function ue(e, a, t) {
      ...
      var n,
        s = 0 | r._crypto_box_publickeybytes();
      e.length !== s && f(_, "invalid publicKey length"),
        (n = d(e)),
        _.push(n),
        (a = E(_, a, "privateKey"));
      var c,
        o = 0 | r._crypto_box_secretkeybytes();
      a.length !== o && f(_, "invalid privateKey length"),
        (c = d(a)),
        _.push(c);
      var h = new u(0 | r._crypto_box_beforenmbytes()),
        p = h.address;
    ...
    function de(e, a, t) {
      ...
      l(t), (e = E(_, e, "publicKey"));
      var n,
        s = 0 | r._crypto_box_curve25519xchacha20poly1305_publickeybytes();
      e.length !== s && f(_, "invalid publicKey length"),
        (n = d(e)),
        _.push(n),
        (a = E(_, a, "privateKey"));
      var c,
        o = 0 | r._crypto_box_curve25519xchacha20poly1305_secretkeybytes();
      a.length !== o && f(_, "invalid privateKey length"),
        (c = d(a)),
        _.push(c);
      var h = new u(
          0 | r._crypto_box_curve25519xchacha20poly1305_beforenmbytes()
        ),
        p = h.address;
      if (
        (_.push(p),
        !(0 | r._crypto_box_curve25519xchacha20poly1305_beforenm(p, n, c)))
      ) {
        var i = y(h, t);
        return g(_), i;
      }
    ...
    function ve(e, a, t, _, n) {
      var s = [];
      l(n);
      var c = d((e = E(s, e, "message"))),
        o = e.length;
      s.push(c), (a = E(s, a, "nonce"));
      var h,
        p = 0 | r._crypto_box_curve25519xchacha20poly1305_noncebytes();
      a.length !== p && f(s, "invalid nonce length"),
        (h = d(a)),
        s.push(h),
        (t = E(s, t, "publicKey"));
      var i,
        v = 0 | r._crypto_box_curve25519xchacha20poly1305_publickeybytes();
      t.length !== v && f(s, "invalid publicKey length"),
        (i = d(t)),
        s.push(i),
        (_ = E(s, _, "privateKey"));
      var m,
        x = 0 | r._crypto_box_curve25519xchacha20poly1305_secretkeybytes();
      _.length !== x && f(s, "invalid privateKey length"),
        (m = d(_)),
        s.push(m);
      var k = new u(0 | o),
        S = k.address;
      s.push(S);
      var T = new u(0 | r._crypto_box_curve25519xchacha20poly1305_macbytes()),
        w = T.address;
      if (
        (s.push(w),
        !(
    ...
    function ge(e, a, t, _) {
      var n = [];
      l(_);
      var s = d((e = E(n, e, "message"))),
        c = e.length;
      n.push(s), (a = E(n, a, "nonce"));
      var o,
        h = 0 | r._crypto_box_curve25519xchacha20poly1305_noncebytes();
      a.length !== h && f(n, "invalid nonce length"),
        (o = d(a)),
        n.push(o),
        (t = E(n, t, "sharedKey"));
      var p,
        i = 0 | r._crypto_box_curve25519xchacha20poly1305_beforenmbytes();
      t.length !== i && f(n, "invalid sharedKey length"), (p = d(t)), n.push(p);
      var v = new u(0 | c),
        m = v.address;
      n.push(m);
      var x = new u(0 | r._crypto_box_curve25519xchacha20poly1305_macbytes()),
        k = x.address;
      if (
        (n.push(k),
        !(
          0 |
          r._crypto_box_curve25519xchacha20poly1305_detached_afternm(
            m,
            k,
            s,
            c,
    ...
    function be(e, a, t, _, n) {
      ...
      _.length !== x && f(s, "invalid privateKey length"),
        ...
        s.push(m);
      var k = new u(
          (o + r._crypto_box_curve25519xchacha20poly1305_macbytes()) | 0
        ),
        S = k.address;
      if (
        (s.push(S),
        !(
          0 |
          r._crypto_box_curve25519xchacha20poly1305_easy(S, c, o, 0, h, i, m)
        ))
      ) {
        var T = y(k, n);
        return g(s), T;
    ...
    function fe(e, a, t, _) {
      ...
      t.length !== i && f(n, "invalid sharedKey length"), (p = d(t)), n.push(p);
      var v = new u(
          (c + r._crypto_box_curve25519xchacha20poly1305_macbytes()) | 0
        ),
        m = v.address;
      if (
        (n.push(m),
        !(
          0 |
          r._crypto_box_curve25519xchacha20poly1305_easy_afternm(
            m,
            s,
            c,
            0,
    ...
    function me(e) {
      ...
      var c = y({ publicKey: t, privateKey: n, keyType: "curve25519" }, e);
      return g(a), c;
    }
    function Ee(e, a, t, _, n, s) {
      ...
      var p,
        i = 0 | r._crypto_box_curve25519xchacha20poly1305_macbytes();
      a.length !== i && f(c, "invalid mac length"),
        (p = d(a)),
        c.push(p),
        (t = E(c, t, "nonce"));
      var v,
        m = 0 | r._crypto_box_curve25519xchacha20poly1305_noncebytes();
      t.length !== m && f(c, "invalid nonce length"),
        (v = d(t)),
        c.push(v),
        (_ = E(c, _, "publicKey"));
      var x,
        k = 0 | r._crypto_box_curve25519xchacha20poly1305_publickeybytes();
      _.length !== k && f(c, "invalid publicKey length"),
        (x = d(_)),
        c.push(x),
        (n = E(c, n, "privateKey"));
      var S,
        T = 0 | r._crypto_box_curve25519xchacha20poly1305_secretkeybytes();
      ...
      if (
        ...
        !(
          0 |
          r._crypto_box_curve25519xchacha20poly1305_open_detached(
            Y,
            o,
            p,
            h,
    ...
    function xe(e, a, t, _, n) {
      var s = [];
      l(n);
      var c = d((e = E(s, e, "ciphertext"))),
        o = e.length;
      s.push(c), (a = E(s, a, "mac"));
      var h,
        p = 0 | r._crypto_box_curve25519xchacha20poly1305_macbytes();
      a.length !== p && f(s, "invalid mac length"),
        (h = d(a)),
        s.push(h),
        (t = E(s, t, "nonce"));
      var i,
        v = 0 | r._crypto_box_curve25519xchacha20poly1305_noncebytes();
      t.length !== v && f(s, "invalid nonce length"),
        (i = d(t)),
        s.push(i),
        (_ = E(s, _, "sharedKey"));
      var m,
        x = 0 | r._crypto_box_curve25519xchacha20poly1305_beforenmbytes();
      ...
      if (
        ...
        !(
          0 |
          r._crypto_box_curve25519xchacha20poly1305_open_detached_afternm(
            S,
            c,
            h,
            o,
    ...
    function ke(e, a, t, _, n) {
      ...
      var c,
        o = r._crypto_box_curve25519xchacha20poly1305_macbytes(),
        h = e.length;
      h < o && f(s, "ciphertext is too short"),
        ...
        (a = E(s, a, "nonce"));
      var p,
        i = 0 | r._crypto_box_curve25519xchacha20poly1305_noncebytes();
      a.length !== i && f(s, "invalid nonce length"),
        (p = d(a)),
        s.push(p),
        (t = E(s, t, "publicKey"));
      var v,
        m = 0 | r._crypto_box_curve25519xchacha20poly1305_publickeybytes();
      t.length !== m && f(s, "invalid publicKey length"),
        (v = d(t)),
        s.push(v),
        (_ = E(s, _, "privateKey"));
      var x,
        k = 0 | r._crypto_box_curve25519xchacha20poly1305_secretkeybytes();
      _.length !== k && f(s, "invalid privateKey length"),
        (x = d(_)),
        s.push(x);
      var S = new u(
          (h - r._crypto_box_curve25519xchacha20poly1305_macbytes()) | 0
        ),
        T = S.address;
      if (
        (s.push(T),
        !(
          0 |
          r._crypto_box_curve25519xchacha20poly1305_open_easy(
            T,
            c,
            h,
            0,
    ...
    function Te(e, a, t) {
      ...
      var c,
        o = 0 | r._crypto_box_curve25519xchacha20poly1305_publickeybytes();
      a.length !== o && f(_, "invalid publicKey length"), (c = d(a)), _.push(c);
      var h = new u(
          (s + r._crypto_box_curve25519xchacha20poly1305_sealbytes()) | 0
        ),
        p = h.address;
    ...
    function we(e, a, t, _) {
      ...
      var s,
        c = r._crypto_box_curve25519xchacha20poly1305_sealbytes(),
        o = e.length;
      o < c && f(n, "ciphertext is too short"),
        ...
        (a = E(n, a, "publicKey"));
      var h,
        p = 0 | r._crypto_box_curve25519xchacha20poly1305_publickeybytes();
      a.length !== p && f(n, "invalid publicKey length"),
        (h = d(a)),
        n.push(h),
        (t = E(n, t, "secretKey"));
      var i,
        v = 0 | r._crypto_box_curve25519xchacha20poly1305_secretkeybytes();
      t.length !== v && f(n, "invalid secretKey length"), (i = d(t)), n.push(i);
      var b = new u(
          (o - r._crypto_box_curve25519xchacha20poly1305_sealbytes()) | 0
        ),
        m = b.address;
      n.push(m),
        r._crypto_box_curve25519xchacha20poly1305_seal_open(m, s, o, 0, h, i);
      var x = y(b, _);
      return g(n), x;
    }
    function Ye(e, a) {
      ...
      l(a), (e = E(t, e, "seed"));
      var _,
        n = 0 | r._crypto_box_curve25519xchacha20poly1305_seedbytes();
      ...
      if (
        (t.push(h),
        !(0 | r._crypto_box_curve25519xchacha20poly1305_seed_keypair(c, h, _)))
      ) {
        var p = { publicKey: y(s, a), privateKey: y(o, a), keyType: "x25519" };
        return g(t), p;
      }
      b(t, "invalid usage");
    }
    function Be(e, a, t, _, n) {
      ...
      a.length !== p && f(s, "invalid nonce length"),
        ...
        (t = E(s, t, "publicKey"));
      var i,
        v = 0 | r._crypto_box_publickeybytes();
      t.length !== v && f(s, "invalid publicKey length"),
        (i = d(t)),
        s.push(i),
        (_ = E(s, _, "privateKey"));
      ...
      var k = new u(0 | o),
        S = k.address;
      s.push(S);
      var T = new u(0 | r._crypto_box_macbytes()),
        w = T.address;
    ...
    function Ae(e, a, t, _, n) {
      ...
      _.length !== x && f(s, "invalid privateKey length"),
        (m = d(_)),
        s.push(m);
      var k = new u((o + r._crypto_box_macbytes()) | 0),
        S = k.address;
    ...
    function Me(e, a, t, _) {
      ...
      a.length !== h && f(n, "invalid nonce length"),
        ...
        (t = E(n, t, "sharedKey"));
      var p,
        i = 0 | r._crypto_box_beforenmbytes();
      t.length !== i && f(n, "invalid sharedKey length"), (p = d(t)), n.push(p);
      var v = new u((c + r._crypto_box_macbytes()) | 0),
        m = v.address;
    ...
    function Ie(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_box_publickeybytes()),
        _ = t.address;
      a.push(_);
      var n = new u(0 | r._crypto_box_secretkeybytes()),
        s = n.address;
      if ((a.push(s), !(0 | r._crypto_box_keypair(_, s)))) {
        var c = { publicKey: y(t, e), privateKey: y(n, e), keyType: "x25519" };
        return g(a), c;
      }
      b(a, "internal error");
    }
    function Ke(e, a, t, _, n, s) {
      ...
      t.length !== m && f(c, "invalid nonce length"),
        ...
        (_ = E(c, _, "publicKey"));
      var x,
        k = 0 | r._crypto_box_publickeybytes();
      _.length !== k && f(c, "invalid publicKey length"),
        (x = d(_)),
        c.push(x),
        (n = E(c, n, "privateKey"));
      var S,
        T = 0 | r._crypto_box_secretkeybytes();
      n.length !== T && f(c, "invalid privateKey length"),
        (S = d(n)),
        c.push(S);
      var w = new u(0 | h),
        Y = w.address;
      if (
        (c.push(Y), !(0 | r._crypto_box_open_detached(Y, o, p, h, 0, v, x, S)))
      ) {
        var B = y(w, s);
        return g(c), B;
      }
    ...
    function Ne(e, a, t, _, n) {
      ...
      _.length !== k && f(s, "invalid privateKey length"),
        (x = d(_)),
        s.push(x);
      var S = new u((h - r._crypto_box_macbytes()) | 0),
        T = S.address;
    ...
    function Le(e, a, t, _) {
      ...
      var v = new u((c - r._crypto_box_macbytes()) | 0),
        m = v.address;
      if (
        (n.push(m), !(0 | r._crypto_box_open_easy_afternm(m, s, c, 0, o, p)))
      ) {
        var x = y(v, _);
        return g(n), x;
      }
    ...
    function Oe(e, a, t) {
      ...
      _.push(n), (a = E(_, a, "publicKey"));
      var c,
        o = 0 | r._crypto_box_publickeybytes();
      a.length !== o && f(_, "invalid publicKey length"), (c = d(a)), _.push(c);
      var h = new u((s + r._crypto_box_sealbytes()) | 0),
        p = h.address;
    ...
    function Ue(e, a, t, _) {
      ...
      o < c && f(n, "ciphertext is too short"),
        ...
        (a = E(n, a, "publicKey"));
      var h,
        p = 0 | r._crypto_box_publickeybytes();
      a.length !== p && f(n, "invalid publicKey length"),
        (h = d(a)),
        n.push(h),
        (t = E(n, t, "privateKey"));
      var i,
        v = 0 | r._crypto_box_secretkeybytes();
      t.length !== v && f(n, "invalid privateKey length"),
        (i = d(t)),
        n.push(i);
      var m = new u((o - r._crypto_box_sealbytes()) | 0),
        x = m.address;
    ...
    function Ce(e, a) {
      ...
      l(a), (e = E(t, e, "seed"));
      var _,
        n = 0 | r._crypto_box_seedbytes();
      e.length !== n && f(t, "invalid seed length"), (_ = d(e)), t.push(_);
      var s = new u(0 | r._crypto_box_publickeybytes()),
        c = s.address;
      t.push(c);
      var o = new u(0 | r._crypto_box_secretkeybytes()),
        h = o.address;
    ...
    function Pe(e, a, t) {
      ...
      l(t), (e = E(_, e, "p"));
      var n,
        s = 0 | r._crypto_core_ed25519_bytes();
      ...
      var h = new u(0 | r._crypto_core_ed25519_bytes()),
        p = h.address;
    ...
    function Re(e, a) {
      ...
      var _ = d((e = E(t, e, "r")));
      e.length, t.push(_);
      var n = new u(0 | r._crypto_core_ed25519_bytes()),
        s = n.address;
    ...
    function Ge(e, a) {
      ...
      l(a), (e = E(t, e, "repr"));
      var _,
        n = 0 | r._crypto_core_ed25519_bytes();
    ...
    function De(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_core_ed25519_bytes()),
        _ = t.address;
    ...
    function Fe(e, a, t) {
      ...
      l(t), (e = E(_, e, "x"));
      var n,
        s = 0 | r._crypto_core_ed25519_scalarbytes();
      ...
      var h = new u(0 | r._crypto_core_ed25519_scalarbytes()),
        p = h.address;
    ...
    function Ve(e, a) {
      ...
      l(a), (e = E(t, e, "s"));
      var _,
        n = 0 | r._crypto_core_ed25519_scalarbytes();
      e.length !== n && f(t, "invalid s length"), (_ = d(e)), t.push(_);
      var s = new u(0 | r._crypto_core_ed25519_scalarbytes()),
        c = s.address;
    ...
    function je(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_core_ed25519_scalarbytes()),
        _ = t.address;
    ...
    function ze(e, a) {
      ...
      l(a), (e = E(t, e, "sample"));
      var _,
        n = 0 | r._crypto_core_ed25519_nonreducedscalarbytes();
    ...
    function Ze(e, a, t, _) {
      ...
      l(_), (e = E(n, e, "input"));
      var s,
        c = 0 | r._crypto_core_hchacha20_inputbytes();
      e.length !== c && f(n, "invalid input length"),
        (s = d(e)),
        n.push(s),
        (a = E(n, a, "privateKey"));
      var o,
        h = 0 | r._crypto_core_hchacha20_keybytes();
      a.length !== h && f(n, "invalid privateKey length"),
        (o = d(a)),
        n.push(o);
      var p = null;
      null != t && ((p = d((t = E(n, t, "constant")))), t.length, n.push(p));
      var i = new u(0 | r._crypto_core_hchacha20_outputbytes()),
        v = i.address;
    ...
    function $e(e, a, t, _) {
      ...
      l(_), (e = E(n, e, "input"));
      var s,
        c = 0 | r._crypto_core_hsalsa20_inputbytes();
      e.length !== c && f(n, "invalid input length"),
        (s = d(e)),
        n.push(s),
        (a = E(n, a, "privateKey"));
      var o,
        h = 0 | r._crypto_core_hsalsa20_keybytes();
      a.length !== h && f(n, "invalid privateKey length"),
        (o = d(a)),
        n.push(o);
      var p = null;
      null != t && ((p = d((t = E(n, t, "constant")))), t.length, n.push(p));
      var i = new u(0 | r._crypto_core_hsalsa20_outputbytes()),
        v = i.address;
    ...
    function ea(e, a, t) {
      ...
      l(t), (e = E(_, e, "p"));
      var n,
        s = 0 | r._crypto_core_ristretto255_bytes();
      e.length !== s && f(_, "invalid p length"),
        (n = d(e)),
        _.push(n),
        (a = E(_, a, "q"));
      ...
      a.length !== o && f(_, "invalid q length"), (c = d(a)), _.push(c);
      var h = new u(0 | r._crypto_core_ristretto255_bytes()),
        p = h.address;
    ...
    function aa(e, a) {
      ...
      var _ = d((e = E(t, e, "r")));
      e.length, t.push(_);
      var n = new u(0 | r._crypto_core_ristretto255_bytes()),
        s = n.address;
    ...
    function ra(e, a) {
      ...
      l(a), (e = E(t, e, "repr"));
      var _,
        n = 0 | r._crypto_core_ristretto255_bytes();
      e.length !== n && f(t, "invalid repr length"), (_ = d(e)), t.push(_);
    ...
    function ta(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_core_ristretto255_bytes()),
        _ = t.address;
    ...
    function _a(e, a, t) {
      ...
      l(t), (e = E(_, e, "x"));
      var n,
        s = 0 | r._crypto_core_ristretto255_scalarbytes();
      e.length !== s && f(_, "invalid x length"),
        (n = d(e)),
        _.push(n),
        (a = E(_, a, "y"));
      ...
      a.length !== o && f(_, "invalid y length"), (c = d(a)), _.push(c);
      var h = new u(0 | r._crypto_core_ristretto255_scalarbytes()),
        p = h.address;
    ...
    function na(e, a) {
      ...
      l(a), (e = E(t, e, "s"));
      var _,
        n = 0 | r._crypto_core_ristretto255_scalarbytes();
      e.length !== n && f(t, "invalid s length"), (_ = d(e)), t.push(_);
      var s = new u(0 | r._crypto_core_ristretto255_scalarbytes()),
        c = s.address;
    ...
    function ha(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_core_ristretto255_scalarbytes()),
        _ = t.address;
    ...
    function pa(e, a) {
      ...
      l(a), (e = E(t, e, "sample"));
      var _,
        n = 0 | r._crypto_core_ristretto255_nonreducedscalarbytes();
      e.length !== n && f(t, "invalid sample length"), (_ = d(e)), t.push(_);
      var s = new u(0 | r._crypto_core_ristretto255_scalarbytes()),
        c = s.address;
    ...
    function ua(e, a, t, _, n) {
      ...
      null != t &&
        ...
        t.length !== p && f(s, "invalid id length"),
        (h = d(t)),
        s.push(h));
      var i = null,
        v = 0;
      null != _ &&
        ((_ = E(s, _, "ctx")),
        (v = 0 | r._crypto_generichash_blake2b_personalbytes()),
        _.length !== v && f(s, "invalid ctx length"),
        (i = d(_)),
        s.push(i));
      var x = new u(0 | e),
        k = x.address;
    ...
    function va(e, a, t) {
      ...
      var n = null,
        s = 0;
      null != e && ((n = d((e = E(_, e, "key")))), (s = e.length), _.push(n)),
        m(_, a, "hash_length"),
        ("number" != typeof a || (0 | a) !== a || a < 0) &&
          f(_, "hash_length must be an unsigned integer");
    ...
    function ga(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_generichash_keybytes()),
        _ = t.address;
    ...
    function ba(e, a, t) {
      ...
      var n = d((a = E(_, a, "message_chunk"))),
        s = a.length;
      _.push(n),
        0 | r._crypto_generichash_update(e, n, s) && b(_, "invalid usage"),
        g(_);
    }
    function fa(e, a) {
      var t = [];
      l(a);
      var _ = d((e = E(t, e, "message"))),
        n = e.length;
      t.push(_);
      var s = new u(0 | r._crypto_hash_bytes()),
        c = s.address;
    ...
    function ma(e, a) {
      ...
      var _ = d((e = E(t, e, "message"))),
        n = e.length;
      t.push(_);
      var s = new u(0 | r._crypto_hash_sha256_bytes()),
        c = s.address;
    ...
    function Ea(e, a) {
      var t = [];
      l(a), m(t, e, "state_address");
      var _ = new u(0 | r._crypto_hash_sha256_bytes()),
        n = _.address;
    ...
    function ka(e, a, t) {
      ...
      var n = d((a = E(_, a, "message_chunk"))),
        s = a.length;
      _.push(n),
        0 | r._crypto_hash_sha256_update(e, n, s) && b(_, "invalid usage"),
        g(_);
    }
    function Sa(e, a) {
      var t = [];
      ...
      var _ = d((e = E(t, e, "message"))),
        n = e.length;
      t.push(_);
      var s = new u(0 | r._crypto_hash_sha512_bytes()),
        c = s.address;
    ...
    function Ta(e, a) {
      var t = [];
      l(a), m(t, e, "state_address");
      var _ = new u(0 | r._crypto_hash_sha512_bytes()),
        n = _.address;
    ...
    function Ya(e, a, t) {
      ...
      var n = d((a = E(_, a, "message_chunk"))),
        s = a.length;
      _.push(n),
        0 | r._crypto_hash_sha512_update(e, n, s) && b(_, "invalid usage"),
        g(_);
    }
    function Ba(e, a, t, _, s) {
      ...
      if ("bigint" == typeof a && a >= BigInt(0)) {
        const e = a >> BigInt(32);
        e > BigInt(4294967295) && f(c, "subkey_id cannot be more than 64 bits"),
          (h = Number(e)),
          (o = Number(a & BigInt(4294967295)));
      } else
        "number" == typeof a && (0 | a) === a && a >= 0
          ? (o = a)
          : f(c, "subkey_id must be an unsigned integer or bigint");
      "string" != typeof t && f(c, "ctx must be a string"),
        (t = n(t + "\0")),
        null != i && t.length - 1 !== i && f(c, "invalid ctx length");
      var p = d(t),
        i = t.length - 1;
      c.push(p), (_ = E(c, _, "key"));
      var v,
        b = 0 | r._crypto_kdf_keybytes();
    ...
    function Aa(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_kdf_keybytes()),
        _ = t.address;
    ...
    function Ma(e, a, t, _) {
      ...
      var s,
        c = 0 | r._crypto_kx_publickeybytes();
      e.length !== c && f(n, "invalid clientPublicKey length"),
        (s = d(e)),
        n.push(s),
        (a = E(n, a, "clientSecretKey"));
      var o,
        h = 0 | r._crypto_kx_secretkeybytes();
      a.length !== h && f(n, "invalid clientSecretKey length"),
        (o = d(a)),
        n.push(o),
        (t = E(n, t, "serverPublicKey"));
      var p,
        i = 0 | r._crypto_kx_publickeybytes();
      t.length !== i && f(n, "invalid serverPublicKey length"),
        (p = d(t)),
        n.push(p);
      var v = new u(0 | r._crypto_kx_sessionkeybytes()),
        m = v.address;
      n.push(m);
      var x = new u(0 | r._crypto_kx_sessionkeybytes()),
        k = x.address;
      if ((n.push(k), !(0 | r._crypto_kx_client_session_keys(m, k, s, o, p)))) {
        var S = y({ sharedRx: v, sharedTx: x }, _);
        return g(n), S;
      }
      b(n, "invalid usage");
    }
    function Ia(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_kx_publickeybytes()),
        _ = t.address;
      a.push(_);
      var n = new u(0 | r._crypto_kx_secretkeybytes()),
        s = n.address;
    ...
    function Ka(e, a) {
      ...
      l(a), (e = E(t, e, "seed"));
      var _,
        n = 0 | r._crypto_kx_seedbytes();
      e.length !== n && f(t, "invalid seed length"), (_ = d(e)), t.push(_);
      var s = new u(0 | r._crypto_kx_publickeybytes()),
        c = s.address;
      t.push(c);
      var o = new u(0 | r._crypto_kx_secretkeybytes()),
        h = o.address;
    ...
    function Na(e, a, t, _) {
      ...
      e.length !== c && f(n, "invalid serverPublicKey length"),
        (s = d(e)),
        n.push(s),
        (a = E(n, a, "serverSecretKey"));
      var o,
        h = 0 | r._crypto_kx_secretkeybytes();
      a.length !== h && f(n, "invalid serverSecretKey length"),
        (o = d(a)),
        n.push(o),
        (t = E(n, t, "clientPublicKey"));
      var p,
        i = 0 | r._crypto_kx_publickeybytes();
      t.length !== i && f(n, "invalid clientPublicKey length"),
        (p = d(t)),
        n.push(p);
      var v = new u(0 | r._crypto_kx_sessionkeybytes()),
        m = v.address;
    ...
    function La(e, a, t) {
      ...
      _.push(n), (a = E(_, a, "key"));
      var c,
        o = 0 | r._crypto_onetimeauth_keybytes();
      a.length !== o && f(_, "invalid key length"), (c = d(a)), _.push(c);
      var h = new u(0 | r._crypto_onetimeauth_bytes()),
        p = h.address;
    ...
    function Oa(e, a) {
      var t = [];
      l(a), m(t, e, "state_address");
      var _ = new u(0 | r._crypto_onetimeauth_bytes()),
        n = _.address;
    ...
    function Ca(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_onetimeauth_keybytes()),
        _ = t.address;
    ...
    function Pa(e, a, t) {
      ...
      var n = d((a = E(_, a, "message_chunk"))),
        s = a.length;
      _.push(n),
        0 | r._crypto_onetimeauth_update(e, n, s) && b(_, "invalid usage"),
        g(_);
    }
    function Ra(e, a, t) {
      var _ = [];
      e = E(_, e, "hash");
      var n,
        s = 0 | r._crypto_onetimeauth_bytes();
      e.length !== s && f(_, "invalid hash length"), (n = d(e)), _.push(n);
      var c = d((a = E(_, a, "message"))),
        o = a.length;
      _.push(c), (t = E(_, t, "key"));
      var h,
        p = 0 | r._crypto_onetimeauth_keybytes();
      t.length !== p && f(_, "invalid key length"), (h = d(t)), _.push(h);
    ...
    function Xa(e, a, t, _, n, s, c) {
      ...
      var h = d((a = E(o, a, "password"))),
        p = a.length;
      o.push(h), (t = E(o, t, "salt"));
      var i,
        v = 0 | r._crypto_pwhash_saltbytes();
      t.length !== v && f(o, "invalid salt length"),
        (i = d(t)),
        o.push(i),
        m(o, _, "opsLimit"),
      ...
      var x = new u(0 | e),
        k = x.address;
      if (
        (o.push(k), !(0 | r._crypto_pwhash(k, e, 0, h, p, 0, i, _, 0, n, s)))
      ) {
        var S = y(x, c);
        return g(o), S;
      }
    ...
    function Ga(e, a, t, _, n, s) {
      ...
      var o = d((a = E(c, a, "password"))),
        h = a.length;
      c.push(o), (t = E(c, t, "salt"));
      var p,
        i = 0 | r._crypto_pwhash_scryptsalsa208sha256_saltbytes();
      t.length !== i && f(c, "invalid salt length"),
        (p = d(t)),
        c.push(p),
        m(c, _, "opsLimit"),
        ("number" != typeof _ || (0 | _) !== _ || _ < 0) &&
      ...
      if (
        ...
        !(
          0 |
          r._crypto_pwhash_scryptsalsa208sha256(x, e, 0, o, h, 0, p, _, 0, n)
        ))
      ) {
        var k = y(v, s);
        return g(c), k;
    ...
    function Da(e, a, t, _, n, s, c) {
      ...
      if (
        ...
        !(
          0 |
          r._crypto_pwhash_scryptsalsa208sha256_ll(h, p, i, v, t, 0, _, n, k, s)
        ))
      ) {
        var S = y(x, c);
        return g(o), S;
    ...
    function Fa(e, a, t, _) {
      ...
      var o = new u(0 | r._crypto_pwhash_scryptsalsa208sha256_strbytes())
        .address;
      if (
        (n.push(o),
        !(0 | r._crypto_pwhash_scryptsalsa208sha256_str(o, s, c, 0, a, 0, t)))
      ) {
    ...
    function Va(e, a, t) {
      ...
      var s = d(e),
        c = e.length - 1;
      _.push(s);
      var o = d((a = E(_, a, "password"))),
        h = a.length;
      _.push(o);
      var p = !(
        0 | r._crypto_pwhash_scryptsalsa208sha256_str_verify(s, o, h, 0)
      );
      return g(_), p;
    }
    function Ha(e, a, t, _) {
    ...
    function ja(e, a, t) {
      ...
      var n,
        s = 0 | r._crypto_scalarmult_scalarbytes();
      e.length !== s && f(_, "invalid privateKey length"),
        (n = d(e)),
        _.push(n),
        (a = E(_, a, "publicKey"));
      var c,
        o = 0 | r._crypto_scalarmult_bytes();
      a.length !== o && f(_, "invalid publicKey length"), (c = d(a)), _.push(c);
      var h = new u(0 | r._crypto_scalarmult_bytes()),
        p = h.address;
    ...
    function za(e, a) {
      ...
      var _,
        n = 0 | r._crypto_scalarmult_scalarbytes();
      e.length !== n && f(t, "invalid privateKey length"),
        (_ = d(e)),
        t.push(_);
      var s = new u(0 | r._crypto_scalarmult_bytes()),
        c = s.address;
    ...
    function Ja(e, a, t) {
      ...
      l(t), (e = E(_, e, "n"));
      var n,
        s = 0 | r._crypto_scalarmult_ed25519_scalarbytes();
      e.length !== s && f(_, "invalid n length"),
        (n = d(e)),
        _.push(n),
        (a = E(_, a, "p"));
      var c,
        o = 0 | r._crypto_scalarmult_ed25519_bytes();
      a.length !== o && f(_, "invalid p length"), (c = d(a)), _.push(c);
      var h = new u(0 | r._crypto_scalarmult_ed25519_bytes()),
        p = h.address;
    ...
    function Qa(e, a) {
      ...
      l(a), (e = E(t, e, "scalar"));
      var _,
        n = 0 | r._crypto_scalarmult_ed25519_scalarbytes();
      e.length !== n && f(t, "invalid scalar length"), (_ = d(e)), t.push(_);
      var s = new u(0 | r._crypto_scalarmult_ed25519_bytes()),
        c = s.address;
    ...
    function er(e, a, t) {
      ...
      l(t), (e = E(_, e, "scalar"));
      var n,
        s = 0 | r._crypto_scalarmult_ristretto255_scalarbytes();
      e.length !== s && f(_, "invalid scalar length"),
        (n = d(e)),
        _.push(n),
        (a = E(_, a, "element"));
      var c,
        o = 0 | r._crypto_scalarmult_ristretto255_bytes();
      a.length !== o && f(_, "invalid element length"), (c = d(a)), _.push(c);
      var h = new u(0 | r._crypto_scalarmult_ristretto255_bytes()),
        p = h.address;
    ...
    function ar(e, a) {
      ...
      var _,
        n = 0 | r._crypto_core_ristretto255_scalarbytes();
      e.length !== n && f(t, "invalid scalar length"), (_ = d(e)), t.push(_);
      var s = new u(0 | r._crypto_core_ristretto255_bytes()),
        c = s.address;
    ...
    function rr(e, a, t, _) {
      ...
      a.length !== h && f(n, "invalid nonce length"),
        ...
        (t = E(n, t, "key"));
      var p,
        i = 0 | r._crypto_secretbox_keybytes();
      t.length !== i && f(n, "invalid key length"), (p = d(t)), n.push(p);
      var v = new u(0 | c),
        m = v.address;
      n.push(m);
      var x = new u(0 | r._crypto_secretbox_macbytes()),
        k = x.address;
      if (
        (n.push(k), !(0 | r._crypto_secretbox_detached(m, k, s, c, 0, o, p)))
      ) {
        var S = y({ mac: x, cipher: v }, _);
        return g(n), S;
      }
      b(n, "invalid usage");
    }
    function tr(e, a, t, _) {
      ...
      var p,
        i = 0 | r._crypto_secretbox_keybytes();
      t.length !== i && f(n, "invalid key length"), (p = d(t)), n.push(p);
      var v = new u((c + r._crypto_secretbox_macbytes()) | 0),
        m = v.address;
    ...
    function _r(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_secretbox_keybytes()),
        _ = t.address;
    ...
    function nr(e, a, t, _, n) {
      ...
      s.push(c), (a = E(s, a, "mac"));
      var h,
        p = 0 | r._crypto_secretbox_macbytes();
      a.length !== p && f(s, "invalid mac length"),
        (h = d(a)),
        s.push(h),
        (t = E(s, t, "nonce"));
      var i,
        v = 0 | r._crypto_secretbox_noncebytes();
      t.length !== v && f(s, "invalid nonce length"),
        (i = d(t)),
        s.push(i),
        (_ = E(s, _, "key"));
      var m,
        x = 0 | r._crypto_secretbox_keybytes();
      _.length !== x && f(s, "invalid key length"), (m = d(_)), s.push(m);
      var k = new u(0 | o),
        S = k.address;
      if (
        (s.push(S),
        !(0 | r._crypto_secretbox_open_detached(S, c, h, o, 0, i, m)))
      ) {
        var T = y(k, n);
        return g(s), T;
      }
    ...
    function sr(e, a, t, _) {
      ...
      l(_), (e = E(n, e, "ciphertext"));
      var s,
        c = r._crypto_secretbox_macbytes(),
        o = e.length;
      o < c && f(n, "ciphertext is too short"),
        (s = d(e)),
        n.push(s),
        (a = E(n, a, "nonce"));
      var h,
        p = 0 | r._crypto_secretbox_noncebytes();
      a.length !== p && f(n, "invalid nonce length"),
        (h = d(a)),
        n.push(h),
        (t = E(n, t, "key"));
      var i,
        v = 0 | r._crypto_secretbox_keybytes();
      t.length !== v && f(n, "invalid key length"), (i = d(t)), n.push(i);
      var m = new u((o - r._crypto_secretbox_macbytes()) | 0),
        x = m.address;
    ...
    function cr(e, a, t) {
      ...
      l(t), (e = E(_, e, "header"));
      var n,
        s = 0 | r._crypto_secretstream_xchacha20poly1305_headerbytes();
    ...
    function or(e, a) {
      ...
      l(a), (e = E(t, e, "key"));
      var _,
        n = 0 | r._crypto_secretstream_xchacha20poly1305_keybytes();
      e.length !== n && f(t, "invalid key length"), (_ = d(e)), t.push(_);
      var s = new u(52).address,
        c = new u(0 | r._crypto_secretstream_xchacha20poly1305_headerbytes()),
        o = c.address;
      if (
        (t.push(o),
        !(0 | r._crypto_secretstream_xchacha20poly1305_init_push(s, o, _)))
      ) {
        var h = { state: s, header: y(c, a) };
        return g(t), h;
      }
      b(t, "invalid usage");
    }
    function hr(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_secretstream_xchacha20poly1305_keybytes()),
        _ = t.address;
    ...
    function pr(e, a, t, _) {
      ...
      var s,
        c = r._crypto_secretstream_xchacha20poly1305_abytes(),
        o = a.length;
      ...
      var i = new u(
          (o - r._crypto_secretstream_xchacha20poly1305_abytes()) | 0
        ),
        b = i.address;
      n.push(b);
      var x,
    ...
    function yr(e, a, t, _, n) {
      ...
      var c = d((a = E(s, a, "message_chunk"))),
        o = a.length;
      s.push(c);
      var h = null,
        p = 0;
      null != t && ((h = d((t = E(s, t, "ad")))), (p = t.length), s.push(h)),
        m(s, _, "tag"),
        ("number" != typeof _ || (0 | _) !== _ || _ < 0) &&
    ...
    function ir(e, a) {
      ...
      return (
        l(a),
        m(t, e, "state_address"),
        r._crypto_secretstream_xchacha20poly1305_rekey(e),
        g(t),
        !0
      );
    }
    function lr(e, a, t) {
      ...
      _.push(n), (a = E(_, a, "key"));
      var c,
        o = 0 | r._crypto_shorthash_keybytes();
      a.length !== o && f(_, "invalid key length"), (c = d(a)), _.push(c);
      var h = new u(0 | r._crypto_shorthash_bytes()),
        p = h.address;
    ...
    function ur(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_shorthash_keybytes()),
        _ = t.address;
    ...
    function dr(e, a, t) {
      ...
      _.push(n), (a = E(_, a, "key"));
      var c,
        o = 0 | r._crypto_shorthash_siphashx24_keybytes();
      a.length !== o && f(_, "invalid key length"), (c = d(a)), _.push(c);
      var h = new u(0 | r._crypto_shorthash_siphashx24_bytes()),
        p = h.address;
    ...
    function vr(e, a, t) {
      ...
      a.length !== o && f(_, "invalid privateKey length"),
        (c = d(a)),
        _.push(c);
      var h = new u((e.length + r._crypto_sign_bytes()) | 0),
        p = h.address;
    ...
    function gr(e, a, t) {
      ...
      a.length !== o && f(_, "invalid privateKey length"),
        (c = d(a)),
        _.push(c);
      var h = new u(0 | r._crypto_sign_bytes()),
        p = h.address;
    ...
    function br(e, a) {
      ...
      l(a), (e = E(t, e, "edPk"));
      var _,
        n = 0 | r._crypto_sign_publickeybytes();
      e.length !== n && f(t, "invalid edPk length"), (_ = d(e)), t.push(_);
      var s = new u(0 | r._crypto_scalarmult_scalarbytes()),
        c = s.address;
    ...
    function fr(e, a) {
      ...
      l(a), (e = E(t, e, "edSk"));
      var _,
        n = 0 | r._crypto_sign_secretkeybytes();
    ...
    function mr(e, a) {
      ...
      e.length !== n && f(t, "invalid privateKey length"),
        (_ = d(e)),
        t.push(_);
      var s = new u(0 | r._crypto_sign_publickeybytes()),
        c = s.address;
    ...
    function Er(e, a) {
      ...
      e.length !== n && f(t, "invalid privateKey length"),
        (_ = d(e)),
        t.push(_);
      var s = new u(0 | r._crypto_sign_seedbytes()),
        c = s.address;
    ...
    function xr(e, a, t) {
      ...
      var n,
        s = 0 | r._crypto_sign_secretkeybytes();
      a.length !== s && f(_, "invalid privateKey length"),
        (n = d(a)),
        _.push(n);
      var c = new u(0 | r._crypto_sign_bytes()),
        o = c.address;
    ...
    function kr(e, a, t, _) {
      ...
      var s,
        c = 0 | r._crypto_sign_bytes();
      a.length !== c && f(n, "invalid signature length"),
        (s = d(a)),
        n.push(s),
        (t = E(n, t, "publicKey"));
      var o,
    ...
    function Tr(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_sign_publickeybytes()),
        _ = t.address;
      a.push(_);
      var n = new u(0 | r._crypto_sign_secretkeybytes()),
        s = n.address;
      if ((a.push(s), !(0 | r._crypto_sign_keypair(_, s)))) {
        var c = { publicKey: y(t, e), privateKey: y(n, e), keyType: "ed25519" };
        return g(a), c;
      }
      b(a, "internal error");
    }
    function wr(e, a, t) {
      ...
      var p = new u((c - r._crypto_sign_bytes()) | 0),
        i = p.address;
    ...
    function Yr(e, a) {
      ...
      l(a), (e = E(t, e, "seed"));
      var _,
        n = 0 | r._crypto_sign_seedbytes();
      e.length !== n && f(t, "invalid seed length"), (_ = d(e)), t.push(_);
      var s = new u(0 | r._crypto_sign_publickeybytes()),
        c = s.address;
      t.push(c);
      var o = new u(0 | r._crypto_sign_secretkeybytes()),
        h = o.address;
      if ((t.push(h), !(0 | r._crypto_sign_seed_keypair(c, h, _)))) {
        var p = { publicKey: y(s, a), privateKey: y(o, a), keyType: "ed25519" };
        return g(t), p;
      }
      b(t, "invalid usage");
    }
    function Br(e, a, t) {
      ...
      var n = d((a = E(_, a, "message_chunk"))),
        s = a.length;
      _.push(n),
        0 | r._crypto_sign_update(e, n, s, 0) && b(_, "invalid usage"),
        g(_);
    }
    function Ar(e, a, t) {
      var _ = [];
    ...
    function Mr(e, a, t, _) {
      ...
      l(_),
        ...
        (a = E(n, a, "key"));
      var s,
        c = 0 | r._crypto_stream_chacha20_keybytes();
      a.length !== c && f(n, "invalid key length"),
        (s = d(a)),
        n.push(s),
        (t = E(n, t, "nonce"));
      var o,
    ...
    function Ir(e, a, t, _) {
      ...
      a.length !== h && f(n, "invalid nonce length"),
        ...
        (t = E(n, t, "key"));
      var p,
        i = 0 | r._crypto_stream_chacha20_ietf_keybytes();
      t.length !== i && f(n, "invalid key length"), (p = d(t)), n.push(p);
      var v = new u(0 | c),
        m = v.address;
      if (
        (n.push(m), 0 === r._crypto_stream_chacha20_ietf_xor(m, s, c, 0, o, p))
      ) {
        var x = y(v, _);
        return g(n), x;
      }
    ...
    function Kr(e, a, t, _, n) {
      var s = [];
      l(n);
      var c = d((e = E(s, e, "input_message"))),
        o = e.length;
      s.push(c), (a = E(s, a, "nonce"));
      var h,
        p = 0 | r._crypto_stream_chacha20_ietf_noncebytes();
      a.length !== p && f(s, "invalid nonce length"),
        (h = d(a)),
        s.push(h),
        m(s, t, "nonce_increment"),
        ("number" != typeof t || (0 | t) !== t || t < 0) &&
          f(s, "nonce_increment must be an unsigned integer"),
        (_ = E(s, _, "key"));
      var i,
        v = 0 | r._crypto_stream_chacha20_ietf_keybytes();
      _.length !== v && f(s, "invalid key length"), (i = d(_)), s.push(i);
      var x = new u(0 | o),
        k = x.address;
      if (
        (s.push(k),
        0 === r._crypto_stream_chacha20_ietf_xor_ic(k, c, o, 0, h, t, i))
      ) {
        var S = y(x, n);
        return g(s), S;
      }
    ...
    function Nr(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_stream_chacha20_keybytes()),
        _ = t.address;
    ...
    function Or(e, a, t, _, n) {
      ...
      s.push(c), (a = E(s, a, "nonce"));
      var h,
        p = 0 | r._crypto_stream_chacha20_noncebytes();
      a.length !== p && f(s, "invalid nonce length"),
        (h = d(a)),
        s.push(h),
        m(s, t, "nonce_increment"),
        ...
        (_ = E(s, _, "key"));
      var i,
        v = 0 | r._crypto_stream_chacha20_keybytes();
      _.length !== v && f(s, "invalid key length"), (i = d(_)), s.push(i);
      var x = new u(0 | o),
        k = x.address;
      if (
        (s.push(k),
        0 === r._crypto_stream_chacha20_xor_ic(k, c, o, 0, h, t, 0, i))
      ) {
        var S = y(x, n);
        return g(s), S;
      }
    ...
    function Ur(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_stream_keybytes()),
        _ = t.address;
    ...
    function Cr(e) {
      var a = [];
      l(e);
      var t = new u(0 | r._crypto_stream_xchacha20_keybytes()),
        _ = t.address;
    ...
    function Pr(e, a, t, _) {
      ...
      a.length !== h && f(n, "invalid nonce length"),
        ...
        (t = E(n, t, "key"));
      var p,
        i = 0 | r._crypto_stream_xchacha20_keybytes();
      t.length !== i && f(n, "invalid key length"), (p = d(t)), n.push(p);
      var v = new u(0 | c),
        m = v.address;
    ...
    function Rr(e, a, t, _, n) {
      ...
      s.push(c), (a = E(s, a, "nonce"));
      var h,
        p = 0 | r._crypto_stream_xchacha20_noncebytes();
      a.length !== p && f(s, "invalid nonce length"),
        (h = d(a)),
        s.push(h),
        m(s, t, "nonce_increment"),
        ...
        (_ = E(s, _, "key"));
      var i,
        v = 0 | r._crypto_stream_xchacha20_keybytes();
      _.length !== v && f(s, "invalid key length"), (i = d(_)), s.push(i);
      var x = new u(0 | o),
        k = x.address;
      if (
        (s.push(k),
        0 === r._crypto_stream_xchacha20_xor_ic(k, c, o, 0, h, t, 0, i))
      ) {
        var S = y(x, n);
        return g(s), S;
      }
    ...
    function Xr(e, a) {
      ...
      l(a),
        m(t, e, "length"),
        ("number" != typeof e || (0 | e) !== e || e < 0) &&
          f(t, "length must be an unsigned integer");
      var _ = new u(0 | e),
        n = _.address;
    ...
    function Vr(e, a) {
      var t = [];
      l(a);
      for (var _ = r._malloc(24), n = 0; n < 6; n++)
        r.setValue(
          _ + 4 * n,
      ...
      0 | r._randombytes_set_implementation(_) &&
        b(t, "unsupported implementation"),
        g(t);
    }
    function Hr(e) {
    ...
    function Wr(e, a) {
      ...
      l(a),
        m(t, e, "upper_bound"),
        ("number" != typeof e || (0 | e) !== e || e < 0) &&
          f(t, "upper_bound must be an unsigned integer");
    ...
    return (
      (u.prototype.to_Uint8Array = function () {
        ...
        return (
          e.set(r.HEAPU8.subarray(this.address, this.address + this.length)), e
        );
      }),
      (e.add = function (e, a) {
      ...
      (e.compare = function (e, a) {
        ...
        for (var r = 0, t = 1, _ = e.length; _-- > 0; )
          (r |= ((a[_] - e[_]) >> 8) & t), (t &= ((a[_] ^ e[_]) - 1) >> 8);
        return r + r + t - 1;
      }),
      (e.from_base64 = function (e, a) {
        ...
        var t,
          _ = [],
          n = new u((3 * (e = E(_, e, "input")).length) / 4),
          s = d(e),
          c = v(4),
          o = v(4);
        return (
          ...
          r.getValue(o, "i32") - s !== e.length && b(_, "incomplete input"),
          (n.length = r.getValue(c, "i32")),
          (t = n.to_Uint8Array()),
          g(_),
          t
        );
      ...
      (e.from_hex = function (e) {
        var a,
          t = [],
          _ = new u((e = E(t, e, "input")).length / 2),
          n = d(e),
          s = v(4);
        return (
          t.push(n),
          t.push(_.address),
          t.push(_.hex_end_p),
          0 !== r._sodium_hex2bin(_.address, _.length, n, e.length, 0, 0, s) &&
            b(t, "invalid input"),
          r.getValue(s, "i32") - n !== e.length && b(t, "incomplete input"),
          (a = _.to_Uint8Array()),
          g(t),
          a
        );
      ...
      (e.increment = function (e) {
        ...
        for (var a = 256, r = 0, t = e.length; r < t; r++)
          (a >>= 8), (a += e[r]), (e[r] = 255 & a);
      }),
      ...
      (e.pad = function (e, a) {
        ...
        for (var p = h.address, y = h.address + o + a; p < y; p++)
          (r.HEAPU8[p] = e[c]),
            (c += s =
              1 &
              ~(
        ...
        return (
          0 !== r._sodium_pad(n, h.address, e.length, a, h.length) &&
            b(_, "internal error"),
          (h.length = r.getValue(n, "i32")),
          (t = h.to_Uint8Array()),
          g(_),
          t
        );
      ...
      (e.unpad = function (e, a) {
        ...
        return (
          t.push(_),
          t.push(n),
          0 !== r._sodium_unpad(n, _, e.length, a) &&
            b(t, "unsupported/invalid padding"),
          (e = (e = new Uint8Array(e)).subarray(0, r.getValue(n, "i32"))),
          g(t),
          e
        );
      }),
  ...
  "function" == typeof define && define.amd
    ...
    ? a(exports, require("libsodium-sumo"))
    : (e.sodium = a((e.commonJsStrict = {}), e.libsodium)),
    r &&
