...
#   - https://hub.docker.com/_/debian?tab=tags&page=1&name=bookworm-20260112-slim - for the release image
#   - https://pkgs.org/ - resource for finding needed packages
#   - Ex: hexpm/elixir:1.19.5-erlang-28.3-debian-bullseye-20251229-slim
#
