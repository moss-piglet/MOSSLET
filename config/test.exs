...
config :mosslet, MossletWeb.Plugs.ContentSecurityPolicy,
  csp:
    "default-src 'none'; form-action 'self'; script-src 'self' 'unsafe-eval' 'wasm-unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob:; connect-src 'self'; frame-ancestors 'self'; object-src 'self';  base-uri 'self'; frame-src 'self';  manifest-src 'self';"
