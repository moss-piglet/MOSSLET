...
config :esbuild,
  ...
  default: [
    args:
      ~w(js/app.js --bundle --target=es2022 --outdir=../priv/static/assets --external:/fonts/* --external:/images/* --external:@emoji-mart/react --external:emoji-mart --external:fs --external:path --alias:@=.),
...
config :mosslet, :billing_products, [
  ...
  # MOSSLET (Family) — subscription only, per-seat (Phase 2).
  ...
  %{
    ...
    line_items: [
      %{
        id: "family-monthly",
        interval: :month,
        price: System.get_env("STRIPE_PRICE_FAMILY_MONTHLY") || "price_family_monthly",
        quantity: 1,
        amount: 2000,
        included_seats: 5,
        seat_addon_price:
          System.get_env("STRIPE_PRICE_FAMILY_SEAT_MONTHLY") || "price_family_seat_monthly",
        max_seats: 30,
        save_percent: 0,
        trial_days: 14,
        allow_promotion_codes: true
  ...
  %{
    ...
    line_items: [
      %{
        id: "family-yearly",
        interval: :year,
        price: System.get_env("STRIPE_PRICE_FAMILY_YEARLY") || "price_family_yearly",
        quantity: 1,
        amount: 16000,
        monthly_equivalent: 1333,
        included_seats: 5,
        seat_addon_price:
          System.get_env("STRIPE_PRICE_FAMILY_SEAT_YEARLY") || "price_family_seat_yearly",
        max_seats: 30,
        save_percent: 33,
        trial_days: 14,
        allow_promotion_codes: true
